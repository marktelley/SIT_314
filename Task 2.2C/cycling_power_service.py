"""
AUTHOR: Zachary Bull, https://pypi.org/user/zacharyedwardbull/

Orginal Script: https://github.com/zacharyedwardbull/pycycling/blob/master/pycycling/cycling_power_service.py
